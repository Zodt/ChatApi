...
namespace ChatApi.WA.Account
{
    ...
    public interface IAccountOperation
    {
        ...
        IChatApiResponse<IChangeAccountNameResponse?> ChangeAccountName(IChangeAccountNameRequest changeAccountNameRequest,
        ...
        /// <param name="responseSettings">Response message settings</param>
        /// <remarks>Doesn`t work on <b>WhatsApp Business</b></remarks>
        Task<IChatApiResponse<IChangeAccountNameResponse?>> ChangeAccountNameAsync(IChangeAccountNameRequest changeAccountNameRequest,
            IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        IChatApiResponse<IAccountSettingsResponse?> ChangeSettings(IAccountSettingsRequest settingsRequest,
            IResponseSettings? responseSettings = null);
        ...
        /// <param name="settingsRequest">Request parameters</param>
        /// <param name="responseSettings">Response message settings</param>
        Task<IChatApiResponse<IAccountSettingsResponse?>> ChangeSettingsAsync(IAccountSettingsRequest settingsRequest,
            IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        IChatApiResponse<IChangeAccountStatusResponse?> ChangeAccountStatus(IChangeAccountStatusRequest changeAccountStatusRequest,
            IResponseSettings? responseSettings = null);
        ...
        /// <param name="changeAccountStatusRequest">Request parameters</param>
        /// <param name="responseSettings">Response message settings</param>
        Task<IChatApiResponse<IChangeAccountStatusResponse?>> ChangeAccountStatusAsync(IChangeAccountStatusRequest changeAccountStatusRequest,
            IResponseSettings? responseSettings = null);
    }
}
