...
namespace ChatApi.WA.Dialogs.Operations.Interfaces
{
    public interface IWhatsAppBusinessOperations
    {
        ...
        /// </remarks>
        IChatApiResponse<ILabelCollectionResponse?> GetLabels(ILabelCollectionRequest? labelCollectionRequest = null, IResponseSettings? responseSettings = null);
        ...
        ///     The functionality is only available for <b>WhatsApp Business</b>.
        /// </remarks>
        Task<IChatApiResponse<ILabelCollectionResponse?>> GetLabelsAsync(ILabelCollectionRequest? labelCollectionRequest = null, IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        /// <remarks>The functionality is only available for <b>WhatsApp Business</b>.</remarks>
        Task<IChatApiResponse<ILabelCreateResponse?>> CreateLabelAsync(ILabelCreateRequest labelCreateRequest, IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        /// <remarks>The functionality is only available for <b>WhatsApp Business</b>.</remarks>
        Task<IChatApiResponse<ILabelUpdateResponse?>> UpdateLabelAsync(ILabelUpdateRequest labelUpdateRequest, IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        /// <remarks>The functionality is only available for <b>WhatsApp Business</b>.</remarks>
        Task<IChatApiResponse<ILabelRemoveResponse?>> RemoveLabelAsync(ILabelRemoveRequest labelRemoveRequest, IResponseSettings? responseSettings = null);
        ...
        /// <param name="responseSettings">Response message settings</param>
        /// <remarks>The functionality is only available for <b>WhatsApp Business</b>.</remarks>
        Task<IChatApiResponse<IUnlabeledChatResponse?>> UnlabeledChatAsync(IUnlabeledChatRequest unlabeledChat, IResponseSettings? responseSettings = null);
    }
}