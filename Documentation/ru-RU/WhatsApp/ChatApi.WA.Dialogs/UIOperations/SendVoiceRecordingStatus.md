# Отправление статуса "Записывает аудио" в диалог.
...
namespace WhatsAppApiClient
{
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            IVoiceRecordingRequest request = new VoiceRecordingRequest()
            {
                Phone = "+7(999) 111-11-11"// or ChatId = "79991111111@c.us"
            };

            whatsAppResponse = operation.UserInterfaceOperations.SendVoiceRecordingStatus(request);
